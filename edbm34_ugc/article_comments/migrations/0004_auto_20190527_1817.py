# Generated by Django 2.1.5 on 2019-05-27 18:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('article_comments', '0003_remove_commentwithtitle_title'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_type_set_for_articlecomment', to='contenttypes.ContentType', verbose_name='content type')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sites.Site')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articlecomment_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
